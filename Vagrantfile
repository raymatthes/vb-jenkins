...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    apt-get -y install git openjdk-7-jre openjdk-7-jdk rpm mock daemon

    wget -q https://pkg.jenkins.io/debian-stable/binary/jenkins_2.32.3_all.deb
    dpkg -i jenkins_2.32.3_all.deb
